...
class Playground(Widget):
    ...
    def start(self):
        ...
        # a fruit is eaten)
        self.start_time_coeff += (self.start_speed / 2)
        self.running_time_coeff = self.start_time_coeff*1.9
    ...
    def update(self, *args):
        ...
        if self.is_defeated():
            self.reset()
            SnakeApp.screen_manager.current = "defeated_screen"
            return
...
class SnakeTail(Widget):
    ...
    def remove(self):
        ...
        # remove every block of the tail fm the canvas
